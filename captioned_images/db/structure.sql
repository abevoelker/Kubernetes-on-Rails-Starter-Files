...
CREATE TABLE public.captioned_images (
    id bigint NOT NULL,
...
CREATE SEQUENCE public.captioned_images_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
ALTER SEQUENCE public.captioned_images_id_seq OWNED BY public.captioned_images.id;
...
ALTER TABLE ONLY public.captioned_images ALTER COLUMN id SET DEFAULT nextval('public.captioned_images_id_seq'::regclass);
...
ALTER TABLE ONLY public.captioned_images
